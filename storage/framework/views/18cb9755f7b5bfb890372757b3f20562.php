...
<body>
    ...
    <div class="container-sm mt-5">
        <form action="<?php echo e(route('employees.store')); ?>" class="needs-validation" method="POST" novalidate="">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" type="text" name="age"
                                id="age" value="<?php echo e(old('age')); ?>" placeholder="Enter Age" required="">
                            <?php $__errorArgs = ['age'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php /**PATH F:\project\resources\views/employee/create.blade.php ENDPATH**/ ?>